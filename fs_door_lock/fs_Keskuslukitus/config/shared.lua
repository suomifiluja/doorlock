...
globalConf = {
	...
	["CLIENT"] = {
		percentage = 99,				-- Percentage chance of finding keys
...
randomMsg =
{
	"Sinä löysit avaimet virtalukosta",
	"Nappasit avaimet repsikanpenkiltä",
	"Avaimet olivat heitetty kojelaudan päälle, otit ne!",
	"Löysit avaimet penkinalta!",
	"Nappasita avaimet hanskalokerosta!",
	"Kaivoit avaimet repsikan jalkatilan maton alta!",
}
